    ...
    <div className="footer-container">
      ...
      <div className="logo-container">
        ...
        <p>
          ...
          your objectives, financial situation <br /> or needs – it may not be
          appropriate to your situation. Because of that, you should, before
          acting on this information, consider its appropriateness with regard
          to those things. <br /> The information provided should not be
          construed as financial, taxation, or legal advice. <br /> <br />
          ...
          acquiring any financial product, you should obtain the relevant
          Product Disclosure Statement (PDS) for any product mentioned and
          consider its contents before making any decision. Past performance of
          any product discussed on this website is not indicative of future
          performance. We do not warrant that any future forecasts are
          guaranteed to occur.
        </p>
